...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<faraday-stack>, :git => "git://github.com/BenjaminMedia/faraday-stack.git")
      ...
      s.add_dependency(%q<faraday-stack>, :git => "git://github.com/BenjaminMedia/faraday-stack.git")
